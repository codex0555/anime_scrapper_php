...
<?php
    ...
    $nextPage = $page + 1;
    $nextApi = "https://webdis-zgj8.onrender.com/popular?type=2&page=$nextPage";
    $ch = curl_init();
...
<div class="adjust">
<div class="hy">
    <span class="r">Genre : Popular</span>
...
<div class="card-container">
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "$api/popular?type=&page=$page");
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_HEADER, false);
        curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type: application/json"));
