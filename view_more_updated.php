...
<?php
    ...
    $nextPage = $page + 1;
    $nextApi = "https://webdis-zgj8.onrender.com/recent-release?type=1&page=$nextPage";
    $ch = curl_init();
...
<div class="adjust">
<div class="hy">
    <span class="r">Resently Updated</span>
        ...
        foreach ((array)$json1 as $resentUpdated) {
            ...
            <div class="card">
                ...
                <span class="ep_no">Ep <?php echo $resentUpdated['episodeNum'] ?></span>
                    ...
                    <a href="watch/<?= $resentUpdated["episodeId"] ?>-episode-1">
